...
class WC_Gateway_Moneris_Interac extends Framework\SV_WC_Payment_Gateway_Hosted {
	 ...
	 *
	 * Which is configurable within the admin and displayed on checkout. Uses the recommended text from the
	 * integration guide.
	 *
	 * @since 2.0.0
	 *
	 ...
	 *
	 * This is configurable within the admin and displayed on checkout. Uses the recommended text from the integration
	 * guide.
	 *
	 * @since 2.0.0
	 *
