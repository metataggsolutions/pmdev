			...
			<?php endif; // true === $et_contact_info_defined ?>
				...
				<div class="top_right_header">
					...
					<div class="shopping-cart">
						...
						<a href="<?php echo $cart_url;?>">Cart (<?php echo WC()->cart->get_cart_contents_count();  ?>)</a>
					</div>
					<div class="my-account">
						<?php if(is_user_logged_in()){?>
						<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('My Account','woothemes'); ?>"><i class="fa fa-user" aria-hidden="true"></i> <span><?php _e('My Account','woothemes'); ?></span></a>
						<a href="<?php echo wp_logout_url( get_permalink( woocommerce_get_page_id( 'myaccount' ) ) );?>" class="logout-link" href="<?php echo wp_logout_url(site_url()); ?>">(Logout)</a>
						<?php } else { ?>
						<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Login / Register','woothemes'); ?>" class="woo-login-popup-sc-open"><i class="fa fa-user" aria-hidden="true"></i> <?php _e('Login / Register','woothemes'); ?></a>
						<?php } ?>
					</div>
					
					<a class="shopbtn" href="<?php echo site_url()?>/product-category/all-products">SHOP NOW</a>  
				</div>
			</div> <!-- .container -->
		</div> <!-- #top-header -->
	<?php
